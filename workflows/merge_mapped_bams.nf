...
workflow MERGE_MAPPED_BAMS {
    ...
    main:
        ...
        // Quality Calc
        BASE_RECALIBRATOR(MERGE_MAPPED_BAMS.out.merged_sorted_bam)

        // Apply BQSR
        APPLY_BQSR(MERGE_MAPPED_BAMS.out.merged_sorted_bam, BASE_RECALIBRATOR.out.bqsr_recalibration_table)
